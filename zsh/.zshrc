...
# Completions generated by tools that ship their own compdef file (herdr).
# Must come before compinit, or the functions are never picked up. Regenerate
# after a herdr update: herdr completion zsh > ~/.local/share/zsh/site-functions/_herdr
