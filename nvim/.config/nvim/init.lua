-- Custom fork of https://github.com/nvim-lua/kickstart.nvim
...
-- (lua/custom/plugins/vim-tmux-navigator.lua) so that the same keys also
-- cross into tmux panes. Do NOT re-map <C-h/j/k/l> to <C-w> here — that
-- shadows the plugin and breaks tmux pane navigation.
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      -- Configure keymaps and behavior when an LSP attaches to a buffer
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      highlight = {
        ...
        additional_vim_regex_highlighting = false, -- This is to not conflic with Catppuccin
      },
